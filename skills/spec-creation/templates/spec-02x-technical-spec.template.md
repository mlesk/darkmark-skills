...
<!--
This is a `spec-02x` architecture sidecar. It is a conditional formal member of the spec-02 family — see `.github/skills/spec-creation/SKILL.md` §"Architecture sidecar family" and the spec-02 sub-skill Phase H.
