...
<!--
List every architecture sidecar emitted for this solution. Sidecars are conditional formal members of the spec-02 family (see spec-creation SKILL.md §"Architecture sidecar family"). If no sidecars are needed, write "none" and remove the table.
